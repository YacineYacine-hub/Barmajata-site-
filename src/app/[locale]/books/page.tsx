...
export default async function BooksPage({
  ...
  return (
    /* Lot H3 : le catalogue s'ouvrait sur un simple h1 posé sur le fond
       par défaut, sans tête de page. Il reprend le bandeau du registre
       Papier, comme /auteurs — et reste clair : si les pages de lecture
       viraient au sombre, la devanture cesserait d'être distincte. */
    <main>
      {entries.length > 0 && (
        <script
